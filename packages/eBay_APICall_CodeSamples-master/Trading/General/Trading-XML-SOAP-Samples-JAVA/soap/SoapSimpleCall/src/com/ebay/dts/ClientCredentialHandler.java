...
public class ClientCredentialHandler extends BasicHandler {
  ...
  private static String privAppId = "DummyAppId";
  private static String privDevId = "DummyDevId";
  private static String privAuthCert = "DummyCertId";
 ...
 // if the call you are making requires a username and password
 // instead of a token, comment the next 3 lines
      if (getToken() != null) {
      	reqCred.addChildElement("eBayAuthToken", EBLPrefix).addTextNode(getToken());
      }
 ...
 // if the call you are making requires a username and password
 // instead of a token, uncomment the lines below
 /*
      if (getUsername() != null) {
