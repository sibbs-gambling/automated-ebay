    ...
    extends AbstractResponseType
{
     ...
     * 
     */
    public List<PictureManagerSubscriptionType> getSubscription() {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the pictureType property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPictureType().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PictureManagerPictureDisplayType> getPictureType() {
        if (pictureType == null) {
