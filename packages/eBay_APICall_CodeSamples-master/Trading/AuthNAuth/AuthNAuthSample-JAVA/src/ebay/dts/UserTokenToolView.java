 ...
 */
public class UserTokenToolView extends FrameView {
    ...
    public UserTokenToolView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = LaunchApp.getApplication().getMainFrame();
            aboutBox = new AboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        LaunchApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ebay.dts.LaunchApp.class).getContext().getResourceMap(UserTokenToolView.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(ebay.dts.LaunchApp.class).getContext().getActionMap(UserTokenToolView.class, this);
        ...
        if (devID.length() == 0) {
            ...
            try {
                ...
                if (errMsg != null && errMsg.startsWith("RequestError")) {
                    ...
                    BrowserLaunch.openURL(baseSigninURL + ruName + "&SessID=" + encodedSessIDString);
                }
            } catch (Exception ex) {
                ex.printStackTrace();
            }
