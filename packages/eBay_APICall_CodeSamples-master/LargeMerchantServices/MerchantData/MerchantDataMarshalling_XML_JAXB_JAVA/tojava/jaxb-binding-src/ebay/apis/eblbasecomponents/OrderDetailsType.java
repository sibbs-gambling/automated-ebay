...
public class OrderDetailsType {
    ...
    @XmlElement(name = "OrderCreationTime")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar orderCreationTime;
     ...
     *     
     */
    public XMLGregorianCalendar getOrderCreationTime() {
     ...
     *     
     */
    public void setOrderCreationTime(XMLGregorianCalendar value) {
