...
===========================================================
1. Set the system variable JWSDP_HOME to point to your Java Web Services Developer Pack installation folder and add ${JWSDP_HOME}/lib to your CLASSPATH
...
4. Run the .jar sample from a command window. 
